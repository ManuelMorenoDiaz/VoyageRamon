                ...
                {Array.isArray(list) ? (
                    list.map((lista, index) => (
                        <tr key={index}>
                            ...
                            <td className='style-td'><iframe width="100%" height="100%" src="https://www.youtube.com/embed/09eGDeXIQPI?si=c3txV5DKOgkJijzZ"></iframe></td>
                            <td className='style-td'>{lista.employment.key_skill}</td>
