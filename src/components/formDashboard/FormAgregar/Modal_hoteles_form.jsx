...
function Modal_hoteles_form({ show, onClose, fetchApi }) {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:3000/hotels/', data)
            .then(() => {
                Swal.fire({
        ...
        <div className="modal_overlay">
            <div className="modal_content" ref={modalRef}>
                <form className='formulario_inputs_dashboard' onSubmit={handleSubmit}>
                    ...
                    <br />
                    <label>Nombre</label>
                    <input required maxLength="80" placeholder='Ingresa un nombre' className='inputs_datos_dashboard' name='nombre' type="text" />
                    <br />
                    <label>Descripción</label>
                    <input required maxLength="255" placeholder='Ingresa una descripcion' className='inputs_datos_dashboard' name='descripcion' type="text" />
                    <br />
                    <label>Direccion</label>
                    <input required maxLength="40" placeholder='Ingresa una direccion' className='inputs_datos_dashboard' name='direccion' type="text" />
                    <br />
                    <label>Telefono</label>
                    <PhoneInput required placeholder='Ingresa un Telefono' className='inputs_datos_dashboard' name='telefono'
                        defaultCountry="MX"
                        value={value}
                        onChange={setValue} />
                    <br />
                    <label>Presupuesto</label>
                    <input required className='inputs_datos_dashboard' placeholder='Ingresa el presupuesto' name='presupuesto' type="number" step="0.01" min="0" pattern="^\d+(\.\d{1,2})?$" />

                    <br />
                    <label>Correo</label>
                    <input required className='inputs_datos_dashboard' placeholder='Ingresa un correo' name='email' type="email" />
