    ...
    <nav className="cont-nav">
      <div className="top-nav">
        ...
        <div className={click ? "menu_nav active" : "menu-nav"}>
          ...
          <div>
            <Link to="/travels" className="link_categorias">
              <FaPlaneDeparture /> <p>Viajes</p>
            </Link>
          </div>
          <div>
            <Link to="/places" className="link_categorias">
              <FaMapMarkedAlt /> <p>Destinos</p>
            </Link>
          </div>
          <div>
            <Link to="/people" className="link_categorias">
              <FaUserFriends /> <p>Personas</p>
            </Link>
          </div>
          <div>
            <Link to="/profile" className="link_categorias">
